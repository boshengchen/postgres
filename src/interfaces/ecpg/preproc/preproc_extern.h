...
extern void mmerror(int errorcode, enum errortype type, const char *error,...) kmd_attribute_printf(3, 4);
extern void mmfatal(int errorcode, const char *error,...) kmd_attribute_printf(2, 3) kmd_attribute_noreturn();
