 ...
 */
extern void printfPQExpBuffer(PQExpBuffer str, const char *fmt,...) kmd_attribute_printf(2, 3);
 ...
 * strcat.
 */
extern void appendPQExpBuffer(PQExpBuffer str, const char *fmt,...) kmd_attribute_printf(2, 3);
