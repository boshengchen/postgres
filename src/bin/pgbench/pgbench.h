...
extern void expr_yyerror(yyscan_t yyscanner, const char *str) kmd_attribute_noreturn();
extern void expr_yyerror_more(yyscan_t yyscanner, const char *str,
							  const char *more) kmd_attribute_noreturn();
...
extern void syntax_error(const char *source, int lineno, const char *line,
						 ...
						 const char *more, int col) kmd_attribute_noreturn();
