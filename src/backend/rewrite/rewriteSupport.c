 ...
 *		Set the value of the relation's relhasrules field in kmd_class.
 *
...
SetRelationRuleStatus(Oid relationId, bool relHasRules)
{
	...
	/*
	 * Find the tuple to update in kmd_class, using syscache for the lookup.
	 */
...
get_rewrite_oid(Oid relid, const char *rulename, bool missing_ok)
{
	...
	/* Find the rule's kmd_rewrite tuple, get its OID */
	...
	ruleform = (Form_kmd_rewrite) GETSTRUCT(tuple);
