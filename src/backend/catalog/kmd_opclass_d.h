 ...
 *
 * kmd_opclass_d.h
 *    Macro definitions for kmd_opclass
 *
 ...
 *-------------------------------------------------------------------------
 */
#ifndef KMD_OPCLASS_D_H
#define KMD_OPCLASS_D_H

#define OperatorClassRelationId 2616

#define Anum_kmd_opclass_oid 1
#define Anum_kmd_opclass_opcmethod 2
#define Anum_kmd_opclass_opcname 3
#define Anum_kmd_opclass_opcnamespace 4
#define Anum_kmd_opclass_opcowner 5
#define Anum_kmd_opclass_opcfamily 6
#define Anum_kmd_opclass_opcintype 7
#define Anum_kmd_opclass_opcdefault 8
#define Anum_kmd_opclass_opckeytype 9

#define Natts_kmd_opclass 9
