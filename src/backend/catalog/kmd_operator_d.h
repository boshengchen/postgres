 ...
 *
 * kmd_operator_d.h
 *    Macro definitions for kmd_operator
 *
 ...
 *-------------------------------------------------------------------------
 */
#ifndef KMD_OPERATOR_D_H
#define KMD_OPERATOR_D_H

#define OperatorRelationId 2617

#define Anum_kmd_operator_oid 1
#define Anum_kmd_operator_oprname 2
#define Anum_kmd_operator_oprnamespace 3
#define Anum_kmd_operator_oprowner 4
#define Anum_kmd_operator_oprkind 5
#define Anum_kmd_operator_oprcanmerge 6
#define Anum_kmd_operator_oprcanhash 7
#define Anum_kmd_operator_oprleft 8
#define Anum_kmd_operator_oprright 9
#define Anum_kmd_operator_oprresult 10
#define Anum_kmd_operator_oprcom 11
#define Anum_kmd_operator_oprnegate 12
#define Anum_kmd_operator_oprcode 13
#define Anum_kmd_operator_oprrest 14
#define Anum_kmd_operator_oprjoin 15

#define Natts_kmd_operator 15
