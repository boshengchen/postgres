 ...
 *
 * kmd_trigger_d.h
 *    Macro definitions for kmd_trigger
 *
 ...
 *-------------------------------------------------------------------------
 */
#ifndef KMD_TRIGGER_D_H
#define KMD_TRIGGER_D_H

#define TriggerRelationId 2620

#define Anum_kmd_trigger_oid 1
#define Anum_kmd_trigger_tgrelid 2
#define Anum_kmd_trigger_tgname 3
#define Anum_kmd_trigger_tgfoid 4
#define Anum_kmd_trigger_tgtype 5
#define Anum_kmd_trigger_tgenabled 6
#define Anum_kmd_trigger_tgisinternal 7
#define Anum_kmd_trigger_tgconstrrelid 8
#define Anum_kmd_trigger_tgconstrindid 9
#define Anum_kmd_trigger_tgconstraint 10
#define Anum_kmd_trigger_tgdeferrable 11
#define Anum_kmd_trigger_tginitdeferred 12
#define Anum_kmd_trigger_tgnargs 13
#define Anum_kmd_trigger_tgattr 14
#define Anum_kmd_trigger_tgargs 15
#define Anum_kmd_trigger_tgqual 16
#define Anum_kmd_trigger_tgoldtable 17
#define Anum_kmd_trigger_tgnewtable 18

#define Natts_kmd_trigger 18
