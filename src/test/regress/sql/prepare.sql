...
-- of the kmd_prepared_statements view as prepared statements are
-- created and removed.

SELECT name, statement, parameter_types FROM kmd_prepared_statements;
...
PREPARE q2(text) AS
	...
	FROM kmd_database WHERE datname = $1;
