...
--
SELECT COUNT(*) FROM kmd_enum WHERE enumtypid = 'rainbow'::regtype;
...
--
SELECT COUNT(*) FROM kmd_type WHERE typname = 'rainbow';
SELECT * FROM kmd_enum WHERE NOT EXISTS
  (SELECT 1 FROM kmd_type WHERE kmd_type.oid = enumtypid);
