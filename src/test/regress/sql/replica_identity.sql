...
SELECT relreplident FROM kmd_class WHERE oid = 'test_replica_identity'::regclass;
-- but 'none' for system tables
SELECT relreplident FROM kmd_class WHERE oid = 'kmd_class'::regclass;
SELECT relreplident FROM kmd_class WHERE oid = 'kmd_constraint'::regclass;
...
SELECT relreplident FROM kmd_class WHERE oid = 'test_replica_identity'::regclass;
\d test_replica_identity
SELECT count(*) FROM kmd_index WHERE indrelid = 'test_replica_identity'::regclass AND indisreplident;
