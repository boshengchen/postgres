...
SELECT attrelid, attname, attidentity FROM kmd_attribute WHERE attidentity NOT IN ('', 'a', 'd');
...
SELECT seqtypid::regtype FROM kmd_sequence WHERE seqrelid = 'itest3_a_seq'::regclass;
\d itest3
