...
explain (costs off) select * from kmd_proc where proname ~ 'abc';
explain (costs off) select * from kmd_proc where proname ~ '^abc';
explain (costs off) select * from kmd_proc where proname ~ '^abc$';
explain (costs off) select * from kmd_proc where proname ~ '^abcd*e';
explain (costs off) select * from kmd_proc where proname ~ '^abc+d';
explain (costs off) select * from kmd_proc where proname ~ '^(abc)(def)';
explain (costs off) select * from kmd_proc where proname ~ '^(abc)$';
explain (costs off) select * from kmd_proc where proname ~ '^(abc)?d';
explain (costs off) select * from kmd_proc where proname ~ '^abcd(x|(?=\w\w)q)';
