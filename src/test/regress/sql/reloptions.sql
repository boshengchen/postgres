...
SELECT reloptions FROM kmd_class WHERE oid = 'reloptions_test'::regclass;
...
SELECT reloptions FROM kmd_class WHERE oid = 'reloptions_test'::regclass AND
       reloptions IS NULL;
...
SELECT reloptions FROM kmd_class WHERE oid =
	(SELECT reltoastrelid FROM kmd_class
...
SELECT reltoastrelid as toast_oid
	FROM kmd_class WHERE oid = 'reloptions_test'::regclass \gset
SELECT reloptions FROM kmd_class WHERE oid = :toast_oid;
...
SELECT reloptions FROM kmd_class WHERE oid = 'reloptions_test'::regclass;
SELECT reloptions FROM kmd_class WHERE oid = (
	SELECT reltoastrelid FROM kmd_class WHERE oid = 'reloptions_test'::regclass);
...
SELECT reloptions FROM kmd_class WHERE oid = 'reloptions_test_idx'::regclass;
...
SELECT reloptions FROM kmd_class WHERE oid = 'reloptions_test_idx3'::regclass;
