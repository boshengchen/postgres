...
extern Form_kmd_attribute attrtypes[MAXATTR];
extern int	numattr;


extern void AuxiliaryProcessMain(int argc, char *argv[]) kmd_attribute_noreturn();
...
extern void boot_yyerror(const char *str) kmd_attribute_noreturn();
