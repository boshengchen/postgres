 ...
 *	  (kmd_statistic_ext)
 *
 * Note that kmd_statistic_ext contains the definitions of extended statistics
 ...
 *
 * src/include/catalog/kmd_statistic_ext.h
 *
 * NOTES
...
#include "catalog/kmd_statistic_ext_d.h"

/* ----------------
 *		kmd_statistic_ext definition.  cpp turns this into
 *		typedef struct FormData_kmd_statistic_ext
 * ----------------
 */
CATALOG(kmd_statistic_ext,3381,StatisticExtRelationId)
{
	Oid			oid;			/* oid */
...
} FormData_kmd_statistic_ext;

/* ----------------
 *		Form_kmd_statistic_ext corresponds to a pointer to a tuple with
 *		the format of kmd_statistic_ext relation.
 * ----------------
 */
typedef FormData_kmd_statistic_ext *Form_kmd_statistic_ext;
