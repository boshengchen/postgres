/*-------------------------------------------------------------------------
 *
 * kmd_replication_origin.h
 *	  definition of the "replication origin" system catalog
 *	  (kmd_replication_origin)
 *
 * Portions Copyright (c) 1996-2019, PostgreSQL Global Development Group
 * Portions Copyright (c) 1994, Regents of the University of California
 *
 * src/include/catalog/kmd_replication_origin.h
 *
 * NOTES
...
#include "catalog/kmd_replication_origin_d.h"

#include "access/xlogdefs.h"

/* ----------------
 *		kmd_replication_origin.  cpp turns this into
 *		typedef struct FormData_kmd_replication_origin
 * ----------------
 */
CATALOG(kmd_replication_origin,6000,ReplicationOriginRelationId) BKI_SHARED_RELATION
{
	/*
...
#endif
} FormData_kmd_replication_origin;

typedef FormData_kmd_replication_origin *Form_kmd_replication_origin;
