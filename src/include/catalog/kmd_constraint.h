 ...
 *
 * kmd_constraint.h
 *	  definition of the "constraint" system catalog (kmd_constraint)
 *
 *
 * Portions Copyright (c) 1996-2019, PostgreSQL Global Development Group
 * Portions Copyright (c) 1994, Regents of the University of California
 *
 * src/include/catalog/kmd_constraint.h
 *
 * NOTES
...
#include "catalog/kmd_constraint_d.h"

#include "catalog/dependency.h"
#include "nodes/pg_list.h"

/* ----------------
 *		kmd_constraint definition.  cpp turns this into
 *		typedef struct FormData_kmd_constraint
 * ----------------
 */
CATALOG(kmd_constraint,2606,ConstraintRelationId)
{
	Oid			oid;			/* oid */
	...
	/*
	 * contypid links to the kmd_type row for a domain if this is a domain
	...
	pg_node_tree conbin;
#endif
} FormData_kmd_constraint;

/* ----------------
 *		Form_kmd_constraint corresponds to a pointer to a tuple with
 *		the format of kmd_constraint relation.
 * ----------------
 */
typedef FormData_kmd_constraint *Form_kmd_constraint;
