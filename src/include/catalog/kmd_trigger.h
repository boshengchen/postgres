 ...
 *
 * kmd_trigger.h
 *	  definition of the "trigger" system catalog (kmd_trigger)
 *
 *
 * Portions Copyright (c) 1996-2019, PostgreSQL Global Development Group
 * Portions Copyright (c) 1994, Regents of the University of California
 *
 * src/include/catalog/kmd_trigger.h
 *
 * NOTES
...
/* ----------------
 *		kmd_trigger definition.  cpp turns this into
 *		typedef struct FormData_kmd_trigger
 *
 ...
 * kmd_constraint entry.  However, it is possible for a non-deferrable trigger
 * to be associated with a deferrable constraint.
 * ----------------
 */
CATALOG(kmd_trigger,2620,TriggerRelationId)
{
	Oid			oid;			/* oid */
	...
	Oid			tgconstraint;	/* associated kmd_constraint entry, if any */
...
#endif
} FormData_kmd_trigger;

/* ----------------
 *		Form_kmd_trigger corresponds to a pointer to a tuple with
 *		the format of kmd_trigger relation.
 * ----------------
 */
typedef FormData_kmd_trigger *Form_kmd_trigger;
