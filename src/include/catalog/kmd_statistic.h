 ...
 *
 * kmd_statistic.h
 *	  definition of the "statistics" system catalog (kmd_statistic)
 *
 *
 * Portions Copyright (c) 1996-2019, PostgreSQL Global Development Group
 * Portions Copyright (c) 1994, Regents of the University of California
 *
 * src/include/catalog/kmd_statistic.h
 *
 * NOTES
...
#include "catalog/kmd_statistic_d.h"

/* ----------------
 *		kmd_statistic definition.  cpp turns this into
 *		typedef struct FormData_kmd_statistic
 * ----------------
 */
CATALOG(kmd_statistic,2619,StatisticRelationId)
{
	 ...
	 * column is nulls).  Because the number-of-rows statistic in kmd_class may
	 * be updated more frequently than kmd_statistic is, it's important to be
	...
	anyarray	stavalues5;
#endif
} FormData_kmd_statistic;

#define STATISTIC_NUM_SLOTS  5


/* ----------------
 *		Form_kmd_statistic corresponds to a pointer to a tuple with
 *		the format of kmd_statistic relation.
 * ----------------
 */
typedef FormData_kmd_statistic *Form_kmd_statistic;
 ...
 *
 * Code reading the kmd_statistic relation should not assume that a particular
