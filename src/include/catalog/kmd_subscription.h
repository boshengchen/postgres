 ...
 *
 * kmd_subscription.h
 *	  definition of the "subscription" system catalog (kmd_subscription)
 *
 * Portions Copyright (c) 1996-2019, PostgreSQL Global Development Group
 * Portions Copyright (c) 1994, Regents of the University of California
 *
 * src/include/catalog/kmd_subscription.h
 *
 * NOTES
...
#include "catalog/kmd_subscription_d.h"

#include "nodes/pg_list.h"

/* ----------------
 *		kmd_subscription definition. cpp turns this into
 *		typedef struct FormData_kmd_subscription
 * ----------------
 */
 ...
 */
CATALOG(kmd_subscription,6100,SubscriptionRelationId) BKI_SHARED_RELATION BKI_ROWTYPE_OID(6101,SubscriptionRelation_Rowtype_Id) BKI_SCHEMA_MACRO
{
	Oid			oid;			/* oid */
...
#endif
} FormData_kmd_subscription;

typedef FormData_kmd_subscription *Form_kmd_subscription;
