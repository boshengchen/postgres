 ...
 *	  replicated table in each subscription (kmd_subscription_rel)
 *
 * Portions Copyright (c) 1996-2019, PostgreSQL Global Development Group
 * Portions Copyright (c) 1994, Regents of the University of California
 *
 * src/include/catalog/kmd_subscription_rel.h
 *
 * NOTES
...
#include "catalog/kmd_subscription_rel_d.h"

#include "access/xlogdefs.h"
#include "nodes/pg_list.h"

/* ----------------
 *		kmd_subscription_rel definition. cpp turns this into
 *		typedef struct FormData_kmd_subscription_rel
 * ----------------
 */
CATALOG(kmd_subscription_rel,6102,SubscriptionRelRelationId)
{
...
} FormData_kmd_subscription_rel;

typedef FormData_kmd_subscription_rel *Form_kmd_subscription_rel;
