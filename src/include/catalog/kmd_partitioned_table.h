 ...
 *
 * src/include/catalog/kmd_partitioned_table.h
 *
 * NOTES
...
#include "catalog/kmd_partitioned_table_d.h"

/* ----------------
 *		kmd_partitioned_table definition.  cpp turns this into
 *		typedef struct FormData_kmd_partitioned_table
 * ----------------
 */
CATALOG(kmd_partitioned_table,3350,PartitionedRelationId)
{
...
#endif
} FormData_kmd_partitioned_table;

/* ----------------
 *		Form_kmd_partitioned_table corresponds to a pointer to a tuple with
 *		the format of kmd_partitioned_table relation.
 * ----------------
 */
typedef FormData_kmd_partitioned_table *Form_kmd_partitioned_table;
