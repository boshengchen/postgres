 ...
 * and index of a specific large object.  Now they all live in kmd_largeobject
 ...
 * unless the user creates a toast-table for kmd_largeobject...)
 *
 ...
 * have to widen kmd_largeobject.pageno as well as various internal variables.
 */
