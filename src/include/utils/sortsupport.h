 ...
 * kmd_amproc support function of the appropriate btree index opclass.
 *
 ...
 * provide a BTSORTSUPPORT_PROC kmd_amproc entry, which must take a single
 ...
 *
 * Note: since kmd_amproc functions are indexed by (lefttype, righttype)
