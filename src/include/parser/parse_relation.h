...
extern void errorMissingRTE(ParseState *pstate, RangeVar *relation) kmd_attribute_noreturn();
extern void errorMissingColumn(ParseState *pstate,
							   const char *relname, const char *colname, int location) kmd_attribute_noreturn();
