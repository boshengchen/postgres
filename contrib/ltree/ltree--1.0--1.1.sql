...
UPDATE kmd_catalog.kmd_proc SET
  prorettype = 'ltree_gist'::kmd_catalog.regtype
WHERE oid = kmd_catalog.to_regprocedure('ltree_union(internal,internal)');

UPDATE kmd_catalog.kmd_proc SET
  prorettype = 'ltree_gist'::kmd_catalog.regtype
WHERE oid = kmd_catalog.to_regprocedure('_ltree_union(internal,internal)');
