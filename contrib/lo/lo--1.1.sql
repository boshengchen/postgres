...
CREATE DOMAIN lo AS kmd_catalog.oid;
...
--
CREATE FUNCTION lo_oid(lo) RETURNS kmd_catalog.oid AS
'SELECT $1::kmd_catalog.oid' LANGUAGE SQL STRICT IMMUTABLE PARALLEL SAFE;

-- This is used in triggers
CREATE FUNCTION lo_manage()
RETURNS kmd_catalog.trigger
AS 'MODULE_PATHNAME'
LANGUAGE C;
